  ...
  void * untyped_ros_message)
{
  ...
  _RaptorStatus__ros_msg_type * ros_message = static_cast<_RaptorStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
static size_t _RaptorStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__RaptorStatus(
    full_bounded, 0);
}
