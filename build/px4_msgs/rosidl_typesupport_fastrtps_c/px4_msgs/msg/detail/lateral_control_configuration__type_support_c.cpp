...
static size_t _LateralControlConfiguration__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__LateralControlConfiguration(
    full_bounded, 0);
}
