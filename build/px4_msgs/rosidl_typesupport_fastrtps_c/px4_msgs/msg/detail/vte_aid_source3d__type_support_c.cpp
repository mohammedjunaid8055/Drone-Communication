  ...
  void * untyped_ros_message)
{
  ...
  _VteAidSource3d__ros_msg_type * ros_message = static_cast<_VteAidSource3d__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
{
  return max_serialized_size_px4_msgs__msg__VteAidSource3d(
    full_bounded, 0);
}
