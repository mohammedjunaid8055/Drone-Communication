  ...
  void * untyped_ros_message)
{
  ...
  _RangingBeacon__ros_msg_type * ros_message = static_cast<_RangingBeacon__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
static size_t _RangingBeacon__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_px4_msgs__msg__RangingBeacon(
    full_bounded, 0);
}
