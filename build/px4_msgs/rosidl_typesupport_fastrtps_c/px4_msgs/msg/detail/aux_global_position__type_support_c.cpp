...
#include "px4_msgs/msg/detail/aux_global_position__rosidl_typesupport_fastrtps_c.h"
...
using _AuxGlobalPosition__ros_msg_type = px4_msgs__msg__AuxGlobalPosition;
...
size_t get_serialized_size_px4_msgs__msg__AuxGlobalPosition(
  const void * untyped_ros_message,
...
static uint32_t _AuxGlobalPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs__msg__AuxGlobalPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_px4_msgs__msg__AuxGlobalPosition(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_px4_msgs__msg__AuxGlobalPosition(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, AuxGlobalPosition)() {
