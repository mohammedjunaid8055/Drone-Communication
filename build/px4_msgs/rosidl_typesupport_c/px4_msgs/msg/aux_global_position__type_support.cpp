...
static const _AuxGlobalPosition_type_support_symbol_names_t _AuxGlobalPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, AuxGlobalPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, AuxGlobalPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, msg, AuxGlobalPosition)() {
  return &::px4_msgs::msg::rosidl_typesupport_c::AuxGlobalPosition_message_type_support_handle;
}
