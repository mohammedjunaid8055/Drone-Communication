...
static size_t _LongitudinalControlConfiguration__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_LongitudinalControlConfiguration(full_bounded, 0);
}
