...
#include "px4_msgs/msg/detail/vte_aid_source3d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::VteAidSource3d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::VteAidSource3d & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.fusion_status[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: time_since_meas_ms
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_VteAidSource3d(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VteAidSource3d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::VteAidSource3d *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VteAidSource3d__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::VteAidSource3d *>(
...
static size_t _VteAidSource3d__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_VteAidSource3d(full_bounded, 0);
}

static message_type_support_callbacks_t _VteAidSource3d__callbacks = {
  "px4_msgs::msg",
  "VteAidSource3d",
...
static rosidl_message_type_support_t _VteAidSource3d__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VteAidSource3d__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_VteAidSource3d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, VteAidSource3d)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_VteAidSource3d__handle;
}
