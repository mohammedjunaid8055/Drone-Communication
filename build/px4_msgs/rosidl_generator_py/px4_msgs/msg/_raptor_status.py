...
class RaptorStatus(metaclass=Metaclass_RaptorStatus):
    ...
    def __eq__(self, other):
        ...
        if self.trajectory_setpoint_dt_max_since_activation != other.trajectory_setpoint_dt_max_since_activation:
            return False
        if all(self.internal_reference_position != other.internal_reference_position):
            return False
        if all(self.internal_reference_linear_velocity != other.internal_reference_linear_velocity):
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'internal_reference_position' field must be a set or sequence with length 3 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'internal_reference_linear_velocity' field must be a set or sequence with length 3 and each value of type 'float'"
