...
class RaptorInput(metaclass=Metaclass_RaptorInput):
    ...
    def __eq__(self, other):
        ...
        if all(self.angular_velocity != other.angular_velocity):
            return False
        if all(self.previous_action != other.previous_action):
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'linear_velocity' field must be a set or sequence with length 3 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'previous_action' field must be a set or sequence with length 4 and each value of type 'float'"
