...
static rosidl_typesupport_introspection_c__MessageMember ArmingCheckReply__rosidl_typesupport_introspection_c__ArmingCheckReply_message_member_array[21] = {
  {
    "timestamp",  // name
