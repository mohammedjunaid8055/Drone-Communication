...
void RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_init_function(
...
void RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_fini_function(void * message_memory)
{
  px4_msgs__msg__RaptorStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_member_array[24] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_members = {
  "px4_msgs__msg",  // message namespace
  "RaptorStatus",  // message name
  24,  // number of fields
  sizeof(px4_msgs__msg__RaptorStatus),
  RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_member_array,  // message members
  RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_type_support_handle = {
  0,
  &RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, RaptorStatus)() {
  if (!RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_type_support_handle.typesupport_identifier) {
    RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &RaptorStatus__rosidl_typesupport_introspection_c__RaptorStatus_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
