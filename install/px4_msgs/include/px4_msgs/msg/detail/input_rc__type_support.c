...
static rosidl_typesupport_introspection_c__MessageMember InputRc__rosidl_typesupport_introspection_c__InputRc_message_member_array[15] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__InputRc, rc_frame_rate),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__InputRc, link_snr),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
